...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Billing Software by shafi")
        bg_color = "#badc57"
    ...
    # ===========ColdDrinks================================
        ...
        chicken1_lbl = Label(F4, text="Chicken Bread", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
        chicken1_lbl.grid(row=3, column=0, padx=10, pady=10, sticky='W')
        chicken1_txt = Entry(F4, width=10, textvariable=self.coke, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        chicken1_txt.grid(row=3, column=1, padx=10, pady=10)
...
#================totalBill==========================
    def total(self):
        ...
        self.c_d_c_p = self.chicken.get()*300
...
#=========billArea=================================================
    ...
    # ==============Grocery============================
        ...
        if self.chicken.get() != 0:
            self.txtarea.insert(END, f"\n Dettol\t\t{self.chicken.get()}\t\t{self.c_d_c_p}")
        if self.fanta.get() != 0:
